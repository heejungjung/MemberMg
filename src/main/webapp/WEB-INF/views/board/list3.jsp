	...
	<div class="col-lg-12">
		<div class="panel panel-default">
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<c:forEach items="${list}" var="board">
						<tr>
							...
							<td><a class='id' href='<c:out value="${board.name}"/>'>
			...
			<form id='actionForm' action="/board/list" method='get'>
				<input type='hidden' name='pageNum' value='${pageMaker.cri.currentPageNo}'>
				<input type='hidden' name='amount' value='${pageMaker.cri.recordsPerPage}'>
